...
#wandb
wandb.init(project='sentflood',config=dict(
                     num_classes=num_classes,
                     num_frames=num_frames,
                     img_size=img_size,
                     num_workers=num_workers,
                     samples_per_gpu=samples_per_gpu,
                     CLASSES=list(CLASSES),  # Convert tuple to list
...
work_dir="/mnt/isilon/maloulou/gpu50_d"
save_path = work_dir
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type="WandbLoggerHook", by_epoch=True,init_kwargs=dict(
                 project="sentflood", 
                 entity=None, 
                 name=wandb.run.name,
                 config=wandb.config,
...
checkpoint_config = dict(by_epoch=True, interval=600, out_dir=save_path)
